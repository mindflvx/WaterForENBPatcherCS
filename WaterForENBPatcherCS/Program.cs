...
using WaterForENBPatcherCS.Utilities;
using WaterForENBPatcherCS.Settings;
using System.Text;
...
namespace WaterForENBPatcherCS
{
    public class Program
    {
        ...
        public static void RunPatch(IPatcherState<ISkyrimMod, ISkyrimModGetter> state)
        {
            ...
            ISkyrimModGetter? WENB = state.LoadOrder.getModByFileName(_settings.Value.WaterForEnbModName);
            if (WENB is not null) {
                (List<String> modNames, List<ISkyrimModGetter> childMods) = state.LoadOrder.getModsFromMasterIncludingMaster(_settings.Value.WaterForEnbModName, WENB);
                patchWater(state, modNames, childMods);
            }
            else {
                System.Console.WriteLine("Water for ENB not found. Looking for: " + _settings.Value.WaterForEnbModName);
            }
        }
